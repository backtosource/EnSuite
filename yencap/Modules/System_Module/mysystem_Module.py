...
class mysystem_Module(Module):
	"""
		It is the main class of local system state data for the NetConf Agent.
	"""
	
	
	def __init__(self, yanguri, name, path, namespace, cacheLifetime, parameters):
		"""
		...
		"""
		print "module mysystem lance"
		Module.__init__(self, yanguri, name, path, namespace, cacheLifetime, parameters)
