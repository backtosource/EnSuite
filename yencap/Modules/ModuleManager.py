...
class ModuleManager:
	...
	def __init__(self):
		...
		# init the readed prefix and namespaces
		self.namespaces = {}
	...
	def loadModules(self):
		...
		# return a description of each module and global namespaces with
		# their associated prefix (used in xpath)
		#moduleDescrList, self.namespaces = ModuleReader.getInstance().readModules()
